                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="text-right space-y-1">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {t('by')} {report.contactName}
                        </div>
                      </div>
                    </div>

                    <div className="mb-4">
                      <p className="text-sm text-muted-foreground mb-2">{t('issues_reported')}:</p>
                        ...
                        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="bg-muted/50 rounded-lg p-4">
                              ...
                              <p className="text-sm"><strong>{t('name')}:</strong> {report.stationName}</p>
                            ...
                            <div className="bg-muted/50 rounded-lg p-4">
                              ...
                              <p className="text-sm"><strong>{t('name')}:</strong> {report.contactName}</p>
                              {report.contactPhone && (
                                <p className="text-sm"><strong>{t('phone')}:</strong> {report.contactPhone}</p>
                              )}
                              {report.contactEmail && (
                                <p className="text-sm"><strong>{t('email')}:</strong> {report.contactEmail}</p>
                              )}
                            </div>
                            ...
                            <div className="bg-muted/50 rounded-lg p-4">
                              ...
                              <div className="flex space-x-4">
                                ...
                                <Badge className={getUrgencyColor(report.urgency)}>
                                  {report.urgency.toUpperCase()} {t('urgency')}
                                </Badge>
                              </div>
                              <p className="text-sm mt-2">
                                <strong>{t('reported')}:</strong> {formatDate(report.timestamp)}
                              </p>
                              {report.assignedTo && (
                                <p className="text-sm">
                                  <strong>{t('assigned_to')}:</strong> {report.assignedTo}
                                </p>
                              )}
                            </div>
